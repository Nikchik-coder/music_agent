...
{{  
    ...
    "song_prompt": "A concise, engaging title for the report", #less than 400 characters
    "negativeTags": "Heavy Metal, Upbeat Drums", #Music styles or traits to exclude from the generated audio.
    "vocalGender": "m", #Available genders: m, f
...
The song prompt must be less than 400 characters, the current length is {song_prompt_length}.
